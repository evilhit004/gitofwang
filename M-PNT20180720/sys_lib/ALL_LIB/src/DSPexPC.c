...
//		  º¯Êı¹¦ÄÜ²»±ä	
//	2015.02.04.
//		1.¸üĞÂÁËExecute_DownLoadº¯Êı£¬Ôö¼ÓÁËÒÔÏÂ¹¦ÄÜ£º
//			a)ÏÂÔØÈí¼ş°æ±¾ĞÅÏ¢
//		2.È¥µôÁËqueue_FirmVÊı×é±äÁ¿£¬¹Ì¼ş°æ±¾ºÅÓ¦±£´æÔÚROMÖĞ£¬²¢ÓÉ¹Ì¼ş³ÌĞò´ÓROM
//		  ÖĞ¶ÁÈ¡ºó·¢ËÍ(Î´ÊµÏÖ)
/********************************************************************************/
...
int Execute_DownLoad(unsigned char	data_type, unsigned char data_size, unsigned int com_addrbase)
{
	...
	while(frame_num)
	{
		...
		switch(data_type)
		{
			...
			case ADDRCHK:		// ÇëÇóµØÖ·É¨ÃèÊı¾İ
												
				break;				
				
			case SOFTV:			// ÇëÇóÈí¼ş°æ±¾ºÅ
