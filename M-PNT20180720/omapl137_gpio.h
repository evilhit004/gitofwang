...
//void OMAPL137_GPIO_setREI(Uint16 number);		// 设置GPIO上升沿触发
//void OMAPL137_GPIO_clrREI(Uint16 number);		// 清除GPIO上升沿触发

//void OMAPL137_GPIO_setFEI(Uint16 number);		// 设置GPIO下降沿触发
//void OMAPL137_GPIO_clrFEI(Uint16 number);		// 清除GPIO下降沿触发

//Int16 OMAPL137_GPIO_ReadISR(Uint16 number);		// 读取GPIO中断状态
//void OMAPL137_GPIO_ClrISR(Uint16 number);		// 清除GPIO中断标志
