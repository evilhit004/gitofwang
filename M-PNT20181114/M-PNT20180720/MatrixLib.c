...
//////////////////********矩阵运算****************//////////////////////
////////////////////////////////////////////////////////////////////////////
void Mat_Multf(FLOAT32 *p1,FLOAT32 *p2,int m,int k,int n,FLOAT32 *p3)//矩阵相乘 单精度浮点
{
	int i,j,l;
	for(i=0;i<m;i++)
	{
...
void MatT(FLOAT64 a[],int m1,int n1,FLOAT64 at[])
{
	 int i,j;
	 for(i=0;i<m1;i++)
	  for(j=0;j<n1;j++)
...
void MatDiv(FLOAT64 a[],FLOAT32 t,int m1,int n1,FLOAT64 at[])
{
	 int i,j,u;
	 for(i=0;i<m1;i++)
	  for(j=0;j<n1;j++)
...
FLOAT32 DelWildGyroPoint(FLOAT32 *fData,int nNum)
{
	char j;
	FLOAT32 fAve;
	fAve = 0 ;
