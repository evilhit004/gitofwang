...
#define EMIFA_AWCC             	(( volatile unsigned int* )( EMIFA_BASE + 0x04 ))	// Asynchronous Wait Cycle Configuration Register
#define EMIFA_CE2CFG            (( volatile unsigned int* )( EMIFA_BASE + 0x10 ))	// Asynchronous 1 Configuration Register
#define EMIFA_CE3CFG            (( volatile unsigned int* )( EMIFA_BASE + 0x14 ))
#define EMIFA_CE4CFG            (( volatile unsigned int* )( EMIFA_BASE + 0x18 ))
#define EMIFA_CE5CFG            (( volatile unsigned int* )( EMIFA_BASE + 0x1C ))
                                
#define EMIFA_INTRAW            (( volatile unsigned int* )( EMIFA_BASE + 0x40 )) // EMIFA Interrupt Raw Register
#define EMIFA_INTMSK            (( volatile unsigned int* )( EMIFA_BASE + 0x44 )) // EMIFA Interrupt Mask Register
#define EMIFA_INTMSKSET         (( volatile unsigned int* )( EMIFA_BASE + 0x48 )) // EMIFA Interrupt Mask Set Register
#define EMIFA_INTMSKCLR         (( volatile unsigned int* )( EMIFA_BASE + 0x4C ))	// EMIFA Interrupt Mask Clear Register	 
...
#define I2C_OAR                 (( volatile unsigned int* )( I2C_BASE + 0x00 ))
#define I2C_ICIMR               (( volatile unsigned int* )( I2C_BASE + 0x04 ))
#define I2C_ICSTR               (( volatile unsigned int* )( I2C_BASE + 0x08 ))
#define I2C_ICCLKL              (( volatile unsigned int* )( I2C_BASE + 0x0C ))
#define I2C_ICCLKH              (( volatile unsigned int* )( I2C_BASE + 0x10 ))
#define I2C_ICCNT               (( volatile unsigned int* )( I2C_BASE + 0x14 ))
#define I2C_ICDRR               (( volatile unsigned int* )( I2C_BASE + 0x18 ))
#define I2C_ICSAR               (( volatile unsigned int* )( I2C_BASE + 0x1C ))
#define I2C_ICDXR               (( volatile unsigned int* )( I2C_BASE + 0x20 ))
#define I2C_ICMDR               (( volatile unsigned int* )( I2C_BASE + 0x24 ))
#define I2C_ICIVR               (( volatile unsigned int* )( I2C_BASE + 0x28 ))
#define I2C_ICEMDR              (( volatile unsigned int* )( I2C_BASE + 0x2C ))
#define I2C_ICPSC               (( volatile unsigned int* )( I2C_BASE + 0x30 ))
#define I2C_ICPID1              (( volatile unsigned int* )( I2C_BASE + 0x34 ))
#define I2C_ICPID2              (( volatile unsigned int* )( I2C_BASE + 0x38 ))
...
//#define INTC_FIQ0               (( volatile unsigned int* )( INTC_BASE + 0x00 ))
//#define INTC_FIQ1               (( volatile unsigned int* )( INTC_BASE + 0x04 ))
//#define INTC_IRQ0               (( volatile unsigned int* )( INTC_BASE + 0x08 ))
//#define INTC_IRQ1               (( volatile unsigned int* )( INTC_BASE + 0x0C ))
//#define INTC_FIQENTRY           (( volatile unsigned int* )( INTC_BASE + 0x10 ))
//#define INTC_IRQENTRY           (( volatile unsigned int* )( INTC_BASE + 0x14 ))
//#define INTC_EINT0              (( volatile unsigned int* )( INTC_BASE + 0x18 ))
//#define INTC_EINT1              (( volatile unsigned int* )( INTC_BASE + 0x1C ))
//#define INTC_INTCTL             (( volatile unsigned int* )( INTC_BASE + 0x20 ))
//#define INTC_EABASE             (( volatile unsigned int* )( INTC_BASE + 0x24 ))
//#define INTC_INTPRI0            (( volatile unsigned int* )( INTC_BASE + 0x30 ))
//#define INTC_INTPRI1            (( volatile unsigned int* )( INTC_BASE + 0x34 ))
//#define INTC_INTPRI2            (( volatile unsigned int* )( INTC_BASE + 0x38 ))
//#define INTC_INTPRI3            (( volatile unsigned int* )( INTC_BASE + 0x3C ))
//#define INTC_INTPRI4            (( volatile unsigned int* )( INTC_BASE + 0x40 ))
//#define INTC_INTPRI5            (( volatile unsigned int* )( INTC_BASE + 0x44 ))
//#define INTC_INTPRI6            (( volatile unsigned int* )( INTC_BASE + 0x48 ))
//#define INTC_INTPRI7            (( volatile unsigned int* )( INTC_BASE + 0x4C ))
...
#define TIMER0_EMUMGT       (( volatile unsigned int* )( TIMER0_BASE + 0x04 ))
...
#define TIMER0_TRC          (( volatile unsigned int* )( TIMER0_BASE + 0x20 ))
#define TIMER0_TGCR         (( volatile unsigned int* )( TIMER0_BASE + 0x24 ))

#define TIMER1_BASE         0x01C21000
#define TIMER1_EMUMGT       (( volatile unsigned int* )( TIMER1_BASE + 0x04 ))
#define TIMER1_TIM12        (( volatile unsigned int* )( TIMER1_BASE + 0x10 ))
#define TIMER1_TIM34        (( volatile unsigned int* )( TIMER1_BASE + 0x14 ))
#define TIMER1_PRD12        (( volatile unsigned int* )( TIMER1_BASE + 0x18 ))
#define TIMER1_PRD34        (( volatile unsigned int* )( TIMER1_BASE + 0x1C ))
#define TIMER1_TRC          (( volatile unsigned int* )( TIMER1_BASE + 0x20 ))
#define TIMER1_TGCR         (( volatile unsigned int* )( TIMER1_BASE + 0x24 ))
...
//#define UART0_DLL           (( volatile unsigned int* )( UART0_BASE + 0x20 ))
//#define UART0_DLH           (( volatile unsigned int* )( UART0_BASE + 0x24 ))
//#define UART0_PID1          (( volatile unsigned int* )( UART0_BASE + 0x28 ))
//#define UART0_PID2          (( volatile unsigned int* )( UART0_BASE + 0x2C ))
//#define UART0_PWREMU_MGMT   (( volatile unsigned int* )( UART0_BASE + 0x30 ))
//
//#define UART1_BASE          0x01D0C000
//#define UART1_RBR           *( volatile unsigned int* )( UART1_BASE + 0x00 )
//#define UART1_THR           *( volatile unsigned int* )( UART1_BASE + 0x00 )
//#define UART1_IER           *( volatile unsigned int* )( UART1_BASE + 0x04 )
//#define UART1_IIR           *( volatile unsigned int* )( UART1_BASE + 0x08 )
//#define UART1_FCR           *( volatile unsigned int* )( UART1_BASE + 0x08 )
//#define UART1_LCR           *( volatile unsigned int* )( UART1_BASE + 0x0C )
//#define UART1_MCR           *( volatile unsigned int* )( UART1_BASE + 0x10 )
//#define UART1_LSR           *( volatile unsigned int* )( UART1_BASE + 0x14 )
//#define UART1_DLL           *( volatile unsigned int* )( UART1_BASE + 0x20 )
//#define UART1_DLH           *( volatile unsigned int* )( UART1_BASE + 0x24 )
//#define UART1_PID1          *( volatile unsigned int* )( UART1_BASE + 0x28 )
//#define UART1_PID2          *( volatile unsigned int* )( UART1_BASE + 0x2C )
//#define UART1_PWREMU_MGMT   *( volatile unsigned int* )( UART1_BASE + 0x30 )
//
//#define UART2_BASE          0x01D0D000
//#define UART2_RBR           *( volatile unsigned int* )( UART2_BASE + 0x00 )
//#define UART2_THR           *( volatile unsigned int* )( UART2_BASE + 0x00 )
//#define UART2_IER           *( volatile unsigned int* )( UART2_BASE + 0x04 )
//#define UART2_IIR           *( volatile unsigned int* )( UART2_BASE + 0x08 )
//#define UART2_FCR           *( volatile unsigned int* )( UART2_BASE + 0x08 )
//#define UART2_LCR           *( volatile unsigned int* )( UART2_BASE + 0x0C )
//#define UART2_MCR           *( volatile unsigned int* )( UART2_BASE + 0x10 )
//#define UART2_LSR           *( volatile unsigned int* )( UART2_BASE + 0x14 )
//#define UART2_DLL           *( volatile unsigned int* )( UART2_BASE + 0x20 )
//#define UART2_DLH           *( volatile unsigned int* )( UART2_BASE + 0x24 )
//#define UART2_PID1          *( volatile unsigned int* )( UART2_BASE + 0x28 )
//#define UART2_PID2          *( volatile unsigned int* )( UART2_BASE + 0x2C )
//#define UART2_PWREMU_MGMT   *( volatile unsigned int* )( UART2_BASE + 0x30 )
//
